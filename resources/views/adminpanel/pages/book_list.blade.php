    ...
    <div class="row">
        ...
        <div class="ibox float-e-margins">
            ...
            @foreach($books as $book)
                <tr class="gradeX" id="row-{{$book->id}}">
                    <td>{{$counter}}</td>
                    <td class="center">{{$book->title}}</td>
                    <td class="center">{{$book->author}}</td>
                    <td class="center">{{date('Y', strtotime($book->book_date))}}</td>
                    <td class="center">{{$book->rack->name}}</td>
                    <td class="center">{{date('d-M-Y', strtotime($book->created_at))}}</td>
...
<script>
    ...
    swal({
        ...
        if (isConfirm) {
            $.ajax({
                method: 'GET',
                url: "{{ route('admin.book.destroy', '') }}/" + id,
